...
from app.users.utils import COOKIE_ACCESS_KEY, JWTBearer
...
async def create_user_address(
    ...
    try:
        address = create_address(db, address, user)
...
async def get_addresses(
    ...
    try:
        ...
        addresses_object =  get_user_addresses(db, token)
        ...
        return [
            AddressResponse.from_orm(address)
